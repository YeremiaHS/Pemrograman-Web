        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if(!filter_var($url, FILTER_VALIDATE_URL)) {
                ...
                if($password !== $cpassword) {
                    ...
                    $msg = "<div class='alert alert-success'> REGISTER SUCCESSFULLY COMPLETE </div>";;
                    $full_name = "";
                    $email = "";
                    $url = "";
                    $password = "";
        ...
        <div class="wrapper">
            ...
            <form action="" method="post" class="form"> 
                ...
                <div class="input-field">
                    ...
                    <input type="text" name="email" class="input" id="email" placeholder="Enter your email address" value="<?php if(isset($_POST['submit'])) {echo $email;}?>">
                </div>
                <div class="input-field">
                    <label for="website" class="input_label"> Website </label>
                    <input type="text" name="url" class="input" id="url" placeholder="Enter your website" value="<?php if(isset($_POST['submit'])) {echo $url;}?>">
                </div>
                <div class="input-field">
                ...
                <div class="input-field">
                    <label for="cpassword" class="input_label"> Confrim Password </label>
                    <input type="password" name="cpassword" class="input" id="cpassword" placeholder="Confirm your password" value="<?php if(isset($_POST['submit'])) {echo $cpassword;}?>">
                </div>
